...
my @slots = (#'Objective_Avg_Combo_Storage', 
				#'Objective_LB_Shortage_Frequency', 
				'Objective_LB_Shortage_Volume', 
				'Objective_Lee_Ferry_Deficit',
				#'Objective_Max_Annual_LB_Shortage', 
				'Objective_Mead_1000', 
				'Objective_Powell_3490',
				#'Objective_Powell_WY_Release'
				'CRSP_Storage',
				'Sum_Powell_Releases',
				'Powell_End_Elev',
				'Mead_End_Elev'
